...
/**
 A generic `ContentViewDefaultSettingsUIKit` class that extends `DMLocalLoadingViewUIKit`
 to provide default settings and configurations for a loading view in UIKit.
...
final class ContentViewDefaultSettingsUIKit<CV: LoadingContentViewUIKit, LVP: DMLoadingViewProviderProtocol>: DMLocalLoadingViewUIKit<CV, LVP> {
    ...
    /**
     ...
     - Parameters:
       - provider: An instance of `LVP` (a `DMLoadingViewProvider`) that provides custom loading and error views.
